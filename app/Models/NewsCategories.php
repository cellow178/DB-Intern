...
class NewsCategories extends Model
{
    ...
    const FILEROOT = "/news_categories";
    const IS_LIST = true;
    const IS_ADD = true;
    const IS_EDIT = true;
    ...
    const FIELD_ADD = ["name", "description", "active", "created_by", "updated_by"];
    ...
    const FIELD_ARRAY = [];
    const FIELD_SORTABLE = ["id", "name", "description", "active", "created_by", "updated_by", "created_at", "updated_at"];
